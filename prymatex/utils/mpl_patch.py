...
def apply():
    ...
    from prymatex.qt import is_pyqt46
    from prymatex.qt.QtGui import QIcon, QCursor, QInputDialog, QMainWindow
    from prymatex.qt.QtCore import Qt, SIGNAL, QObject
    ...
    from prymatex.widgets import formlayout
    ...
    from prymatex.widgets.figureoptions import figure_edit
    class NavigationToolbar2QT(backend_qt4.NavigationToolbar2QT):
        def _init_toolbar(self):
            ...
            if edit_parameters is None:
                ...
                a = self.addAction(resources.getIcon("options.svg"),
