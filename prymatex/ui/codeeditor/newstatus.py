...
#
# Created: Mon Jan  5 09:15:36 2015
...
class Ui_CodeEditorStatus(object):
    def setupUi(self, CodeEditorStatus):
        ...
        self.pushButtonFindRegularExpression = QtWidgets.QPushButton(self.widgetFind)
        icon = QtGui.QIcon.fromTheme("regular-expression")
        self.pushButtonFindRegularExpression.setIcon(icon)
        self.pushButtonFindRegularExpression.setCheckable(True)
        self.pushButtonFindRegularExpression.setObjectName("pushButtonFindRegularExpression")
        self.horizontalLayout_5.addWidget(self.pushButtonFindRegularExpression)
        ...
        self.gridLayout_2.addWidget(self.comboBoxFindInFilesReplace, 2, 7, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.comboBoxFindInFilesWhat, 0, 7, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButtonFindInFilesShowContext, 0, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.comboBoxFindInFilesWhere, 1, 7, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButtonFindInFilesFind, 0, 8, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButtonFindInFilesReplace, 2, 8, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButtonFindInFilesWhere, 1, 8, 1, 1)
        self.line_7 = QtWidgets.QFrame(self.widgetFindInFiles)
    ...
    def retranslateUi(self, CodeEditorStatus):
        ...
        self.pushButtonFindRegularExpression.setToolTip(_translate("CodeEditorStatus", "Regular expression"))
