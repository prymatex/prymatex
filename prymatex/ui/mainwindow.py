...
#
# Created: Wed Dec 28 19:06:05 2011
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuSelect = QtGui.QMenu(self.menuText)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/actions/run-build-file.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNewFileFromTemplate.setIcon(icon20)
        ...
        self.menuText.addAction(self.menuSelect.menuAction())
