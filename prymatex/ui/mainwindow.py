...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/actions/document-close.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/actions/resources/actions/edit-paste.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPaste_As_New.setIcon(icon15)
        self.actionPaste_As_New.setObjectName(_fromUtf8("actionPaste_As_New"))
        self.actionFind = QtGui.QAction(MainWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/actions/edit-find.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/actions/resources/actions/edit-find-replace.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFind_Replace.setIcon(icon17)
        self.actionFind_Replace.setObjectName(_fromUtf8("actionFind_Replace"))
        self.actionPreferences = QtGui.QAction(MainWindow)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/actions/configure.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(_fromUtf8(":/actions/resources/actions/zoom-in.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(_fromUtf8(":/actions/resources/actions/zoom-out.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(_fromUtf8(":/resources/actions/format-indent-less.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShilft_Left.setIcon(icon21)
        self.actionShilft_Left.setObjectName(_fromUtf8("actionShilft_Left"))
        self.actionShift_Right = QtGui.QAction(MainWindow)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(_fromUtf8(":/resources/actions/format-indent-more.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShift_Right.setIcon(icon22)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(_fromUtf8(":/resources/actions/view-filter.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFilter_Through_Command.setIcon(icon23)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(_fromUtf8(":/actions/resources/actions/edit-select-all.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBundle_List.setIcon(icon24)
