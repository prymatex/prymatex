...
class Ui_NewProjectDialog(object):
    def setupUi(self, NewProjectDialog):
        ...
        self.formLayout_2.setLayout(7, QtGui.QFormLayout.FieldRole, self.horizontalLayout_3)
        ...
        self.formLayout_2.setWidget(10, QtGui.QFormLayout.FieldRole, self.comboBoxWorkingSet)
        self.line = QtGui.QFrame(NewProjectDialog)
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName(_fromUtf8("line"))
        self.formLayout_2.setWidget(5, QtGui.QFormLayout.SpanningRole, self.line)
