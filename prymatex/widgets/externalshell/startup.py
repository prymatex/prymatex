...
if os.environ.get('IPYTHON_KERNEL', False):
    ...
    try:
        ...
        if os.name == 'nt':
            ...
            banner2 = """Warning:
Prymatex does not support GUI interactions with IPython >=v0.11
...
#        __ipythonshell__.enable_pylab(gui='qt')
        ...
        __ipythonshell__.stdin_encoding = os.environ['PRYMATEX_ENCODING']
        del banner2
    except ImportError:
        # IPython v0.10
        import IPython.Shell
        __ipythonshell__ = IPython.Shell.start()
        __ipythonshell__.IP.stdin_encoding = os.environ['PRYMATEX_ENCODING']
