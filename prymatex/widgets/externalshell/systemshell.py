...
from prymatex.utils.programs import shell_split
from prymatex.utils.i18n import ugettext as _
from prymatex.widgets.externalshell.baseshell import (ExternalShellBase, add_pathlist_to_PYTHONPATH)
from prymatex.widgets.shell import TerminalWidget
...
class ExternalSystemShell(ExternalShellBase):
    ...
    def get_icon(self):
        return resources.getIcon('cmdprompt.png')
