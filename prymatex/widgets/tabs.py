...
from prymatex.qt.QtGui import (QTabWidget, QMenu, QDrag, QApplication,
                                QTabBar, QShortcut, QKeySequence, QWidget,
                                QHBoxLayout)
from prymatex.qt.QtCore import SIGNAL, Qt, QPoint, QMimeData, QByteArray
...
from prymatex.utils.misc import get_common_path
...
class BaseTabs(QTabWidget):
    ...
    def __init__(self, parent, actions=None, menu=None,
        ...
        self.browse_button = create_toolbutton(self, { 'icon':resources.getIcon("browse_tab.png"),
                                          'tip':_("Browse tabs")})
    ...
    def update_browse_tabs_menu(self):
        ...
        for index, text in enumerate(names):
            tab_action = create_action(self, { 'text': text[offset:],
    ...
    def set_close_function(self, func):
        ...
        try:
            ...
            close_button = create_toolbutton(self, { 'triggered':func,
                                             'icon':resources.getIcon("fileclose.png"),
