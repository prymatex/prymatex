...
PMX_USER_PATH = os.environ['PMX_USER_PATH'] if 'PMX_USER_PATH' in os.environ else os.path.join(os.environ['HOME'], '.prymatex')
PREFERENCES_PATH = os.path.join(PMX_USER_PATH, 'Library', 'Preferences')
